-- Partner gallery crop metadata: preserve originals and reposition/zoom per image.
...
comment on column public.partners.gallery_original_urls is
  'Full-resolution gallery uploads before 4:5 crop, parallel to gallery_image_urls.';
comment on column public.partners.gallery_image_crops is
  'Per-image crop editor state array: [{ "zoom": number, "x": number, "y": number }, ...].';
