-- Partner logo crop metadata: preserve original upload and reposition/zoom settings.
...
comment on column public.partners.logo_crop is
  'Crop editor state: { "zoom": number, "x": number, "y": number }.';

-- Extend submit_partner_application to persist logo original + crop settings.
do $$
declare
  fn record;
begin
