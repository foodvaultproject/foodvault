-- New partner columns (offer_scope, selected_products, crop URLs, etc.) need SELECT
-- grants for authenticated partners reading their listing during application review.
-- Column-level grants do not auto-apply to columns added after the original grant.
