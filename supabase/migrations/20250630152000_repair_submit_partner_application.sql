-- Repair: ensure submit_partner_application includes logo crop params.
-- Safe to run in Supabase SQL Editor if partner application submit fails with
-- "Could not find the function public.submit_partner_application(...)".
