  ...
  return (
    <section className="bg-page">
      <div className="mx-auto max-w-[1200px] px-4 py-10 sm:px-6 lg:px-8">
        <p className="text-xs font-bold uppercase tracking-wide text-primary">Vault Market</p>
        ...
        <Link
          href="/pantry"
          className="fv-btn-primary mt-6 inline-flex h-11 items-center justify-center rounded-sm px-4 text-sm font-semibold text-primary-foreground"
        >
          Browse Vault Market
        </Link>
      </div>
