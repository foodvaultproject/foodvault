  ...
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-lg border border-border bg-background">
      <div className="relative aspect-square overflow-hidden bg-surface">
        ...
        {savePercent > 0 ? (
          <span className="absolute left-2 top-2 z-10 rounded-sm bg-primary px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-primary-foreground">
            {savePercent}% off
          </span>
        ) : null}
        <button
          ...
          className="absolute right-2 top-2 z-10 inline-flex h-8 w-8 items-center justify-center rounded-full bg-background/95 text-primary shadow-sm transition-colors hover:bg-background"
        >
      ...
      <div className="flex flex-1 flex-col p-2.5 sm:p-3">
        ...
        <Link href={href} className="mt-0.5 line-clamp-2 text-sm font-bold leading-snug text-foreground hover:text-primary">
          {product.name}
        </Link>
        {unitPrice ? (
        ...
        <div className="mt-2">
          <span className="inline-flex items-center rounded-sm bg-primary/10 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-primary">
            Member
          </span>
          <p className="mt-1 text-base font-bold leading-none text-primary">
        ...
        <button
          ...
          className="fv-btn-primary mt-auto inline-flex h-9 w-full items-center justify-center rounded-sm px-3 text-xs font-semibold text-primary-foreground transition-[transform,box-shadow] duration-150 disabled:cursor-not-allowed disabled:opacity-60 sm:text-sm"
        >
